...
interface ImageGridProps {
  ...
  onSectionEditText?: (imageType: 'hero' | 'first' | 'second' | 'third') => void;
  refreshKey?: number;
}
...
export default function ImageGrid({
  ...
  const selectedFolderData = selectedFolder ? getFolderById(selectedFolder) : null;

  // Show specialized section manager for main folder
  if (selectedFolderData?.folderType === 'main') {
    return <ImageSectionManager onUploadClick={onSectionUploadClick || (() => {})} onEditText={onSectionEditText} refreshKey={refreshKey} />;
  }

  // Show info message for residential and commercial folders
  if (selectedFolderData?.folderType === 'residential' || selectedFolderData?.folderType === 'commercial') {
    return (
