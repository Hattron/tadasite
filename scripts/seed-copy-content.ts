...
const seedCopyContent = async () => {
  ...
  const copyData = [
    // Home page - About Us section
    {
      ...
      content: 'At TaDa! Interiors, we&apos;ve been bringing inspired design to homes and businesses across Ottawa for over 20 years. From personalized paint consultations to full scale renovations, we offer a wide range of residential and commercial design services tailored to meet each client&apos;s needs.',
      page: 'home',
      section: 'about-us',
    ...
    },
    {
      ...
      content: 'We&apos;re celebrated for our ability to transform and reimagine spaces in a way that reflects every client&apos;s personality, style and lifestyle. Our warm, collaborative approach ensures that every project feels thoughtful, functional, and visually harmonious.',
      page: 'home',
      section: 'about-us',
      contentType: 'paragraph',
    ...
    },
    {
      ...
      title: 'About Us - Team',
      content: 'We work closely with a trusted team of skilled trades professionals, allowing TaDa! Interiors to deliver exceptional craftsmanship and seamless results every step of the way.',
      page: 'home',
      section: 'about-us',
      contentType: 'paragraph',
    ...
    },
    {
      ...
      content: 'Renovating doesn&apos;t have to be stressful. With our experience, guidance, and collaborative approach, we make the journey as enjoyable as the destination - bringing your dream space to life, one thoughtful decision at a time.',
      page: 'about',
      section: 'our-approach',
      contentType: 'paragraph',
    ...
    },
    {
      ...
      content: 'No two clients are alike - and neither are our designs. We create spaces that are as individual as the people who live or work in them.',
      page: 'about',
      section: 'our-approach',
      contentType: 'paragraph',
    ...
    },
    {
      ...
      content: 'Working with TaDa! Interiors means saving time, avoiding costly mistakes, and gaining expert guidance every step of the way. From selecting finishes and furnishings to choosing the perfect lighting, we streamline the process and help you make confident, well-informed decisions.',
      page: 'about',
      section: 'our-approach',
      contentType: 'paragraph',
    ...
    },
    {
      ...
      content: 'Get to know Maureen and Joanna—the heart, soul, and creative force behind every project.',
      page: 'about',
      section: 'meet-team-header',
      contentType: 'paragraph',
    ...
    },
    {
      ...
      content: 'Time and expertise for residential services are billed at an hourly rate of $150.00/hour plus HST',
      page: 'contact',
      section: 'services-residential',
      contentType: 'paragraph',
    ...
    },
    {
      ...
      content: 'In addition to residential work, TaDa! Interiors has completed a wide range of commercial projects. Our portfolio includes - though is not limited to - restaurants, retail environments, office spaces, condominiums and even a church.',
      page: 'contact',
      section: 'services-commercial',
      contentType: 'paragraph',
    ...
    },
    {
      ...
      content: 'Time and expertise for commercial services are billed at an hourly rate of $165.00/hour plus hst',
      page: 'contact',
      section: 'services-commercial',
      contentType: 'paragraph',
